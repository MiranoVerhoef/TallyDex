...
final class LocalCollectionSharingController {
    ...
    .cardtop{display:grid;grid-template-columns:68px minmax(0,1fr);gap:.8rem;align-items:start;min-height:94px}
    .cardtop img,.placeholder{width:68px;height:94px;border-radius:10px}
    .card-copy{min-width:0;padding-top:.15rem}
    .card h2{font-size:1.04rem;line-height:1.2;margin:0 0 .35rem;overflow:hidden;overflow-wrap:normal;word-break:normal;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical}
    .card p{font-size:.88rem;line-height:1.25;overflow:hidden;overflow-wrap:normal;word-break:normal;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical}
    ...
    .market-button .action-icon{background:#ffe8a3}
    .action-copy{min-width:0;display:flex;flex-direction:column;gap:.05rem}
    .action-copy strong,.action-copy small{display:block;max-width:100%;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
    .action-copy strong{font-size:.9rem}
    .action-copy small{font-size:.72rem}
    @container(max-width:245px){.cardtop{grid-template-columns:52px minmax(0,1fr);min-height:74px;gap:.6rem}.cardtop img,.placeholder{width:52px;height:72px}.card h2{font-size:.94rem}.card p{font-size:.78rem}.card-actions{grid-template-columns:1fr}.metadata-button,.market-button{grid-template-columns:1.45rem minmax(0,1fr);min-height:48px;padding:.45rem}.action-icon{width:1.45rem;height:1.45rem}.variant{font-size:.9rem}}
    """
